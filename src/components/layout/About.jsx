  ...
  return (
    <section className="w-full bg-white py-12 px-6 md:px-12 lg:px-20">
      ...
      <div className="max-w-6xl mx-auto">
        <h2 className="text-sm text-gray-600 font-medium mb-2 font-instrument-sans">
          About Montero
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            <h3 className="text-1xl md:text-1xl font-semibold text-gray-900 leading-snug mb-4">
              Montero was born from countless hours spent on beaches around the
              world, watching the tides change and the sun set over different
              horizons.
            </h3>
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(180deg, rgba(35, 175, 248, 0.2) 0%, rgba(35, 175, 248, 0.1) 60%, rgba(35, 175, 248, 0) 100%)",
              }}
            >
              <div className="border-l-2 border-gray-300 pl-3">
                <p className="text-gray-800 text-sm">
                  Meet Montero, a world-time watch crafted for dreamers,
                  explorers, and lovers of the sea.
                </p>
              </div>
              <div className="border-l-2 border-gray-300 pl-3">
                <p className="text-gray-800 text-sm">
                  It's not just about where you are — it's about where you're
                  meant to be.
                </p>
              </div>
              <div className="border-l-2 border-gray-300 pl-3">
                <p className="text-gray-800 text-sm">
                  Inspired by 8 of the world's most iconic beaches, each with
                  its unique time zone, this watch tells more than time — it
                  tells a story.
                </p>
              </div>
              <div className="border-l-2 border-gray-300 pl-3">
                <p className="text-gray-800 text-sm">
                  From the shores of Ibiza to the sands of Bora Bora, Montero
                  connects your wrist to the spirit of adventure.
                </p>
              </div>
            </div>
          </div>
